...
// Constants are stored REVERSED-base64: GitHub secret scanning decodes
// plain base64, so the upstream atob() workaround still trips push
// protection on forks. These are public installed-app OAuth constants.
const decode = (s: string) => atob(s.split("").reverse().join(""));
const CLIENT_ID = decode(
	"t92YuQnblRnbvNmclNXdlx2Zv92ZuMHcwFmLqVzMxIWak1GazYXY2YWchNTZ5AnbyRmcw9mM0ZGOv9WL1kzM5ADO1UjMxgjN",
);
const CLIENT_SECRET = decode("=wGezZEWsNWN1NkNWV2Zts2U38WMt0GUNdGS1RTLYB1UD90R");
